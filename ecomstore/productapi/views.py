...
from productapi.serilizers import ProductSerialzer,ProductModelSerializer,UserSerializer,ReviewSerializer,CartSerializer
...
class ProductView(APIView):
    def get(self,request,*args,**kwargs):
        ...
        seriliazer=ProductSerialzer(qs,many=True)
        return Response(data=seriliazer.data,status=status.HTTP_200_OK)

    def post(self,request,*args,**kwargs):
        serialzer=ProductSerialzer(data=request.data)
...
class ProductDetailView(APIView):
    def get(self,request,*args,**kwargs):
        ...
        serializer=ProductSerialzer(qs)
    ...
    def delete(self,request,*args,**kwargs):
        ...
        serialzer=ProductSerialzer(instance)
        instance.delete()
