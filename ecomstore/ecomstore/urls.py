...
from productapi.views import ProductView,ProductDetailView,ProductModelView,ProductDetailsModelView,ProductViewSetView,ProductModelViewSetView,UserModelViewSet,CartView
from rest_framework.routers import DefaultRouter
from rest_framework.authtoken.views import obtain_auth_token
from  rest_framework_simplejwt.views import TokenObtainPairView,TokenRefreshView
router=DefaultRouter()
router.register("api/v3/products",ProductViewSetView,basename="products")
router.register("api/v5/products",ProductModelViewSetView,basename="products")
router.register("api/v4/users",UserModelViewSet,basename="users")
router.register("api/user/carts",CartView,basename="carts")
urlpatterns = [
    path('admin/', admin.site.urls),
    path('ecomstore/products/',views.ProductView.as_view()),
    path('ecomstore/product/<int:pid>',views.ProductDetailsView.as_view()),
